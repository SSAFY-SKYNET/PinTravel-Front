<template>
  <div
    class="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-6xl mx-auto py-12 md:py-24 px-4 md:px-6"
  >
    ...
    <div class="flex flex-col items-start justify-center">
      <div class="space-y-3">
        ...
        <p class="text-gray-500">
          Select a board to add the pin to, or create a new board.
        </p>
      </div>
      <form class="w-full space-y-4 mt-6" @submit.prevent="submitForm">
        <div class="space-y-2">
          <label for="board" class="block font-medium text-gray-700"
            >Select Board</label
          >
          <select
            id="board"
        ...
        <div v-if="selectedBoard === 'create'">
          ...
          <div class="flex items-center space-x-2">
            ...
            <label for="private" class="block font-medium text-gray-700"
              >Private</label
            >
          </div>
        </div>
